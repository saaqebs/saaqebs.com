const projectList = [
  {
    ...
    image: require("../images/covid.jpg").default,
    buttons: [
      {
        id: 0,
        name: "code",
  ...
  },
  {
    ...
    image: require("../images/safergoogle.png").default,
    buttons: [
      {
        id: 0,
        name: "Github",
  ...
  },
  {
    ...
    image: require("../images/chess.jpeg").default,
    buttons: [
      {
        id: 0,
        name: "Github",
  ...
  },
  {
    ...
    image: require("../images/tasteslikehome.png").default,
    buttons: [
      {
        id: 0,
        name: "Github",
