const projectList = [
  ...
  },
  {
    ...
    description: "Imagine Google but at a smaller and local scale. Could read many text documents and return the top 5 most popular documents based on keywords.",
  ...
  },
  {
    id: 2,
    name: "Tic Tac Toe",
    description: "A game that I used to introduce middle and high school kids to Java and object-oriented programming.",
